...
//    private Paint mUnselectedLinePaint;
    ...
    public WaveformView_2(Context context, AttributeSet attrs) {
        ...
        centerLine.setColor(getResources().getColor(R.color.colorAccent));
...
//        centerLine.setColor(Color.rgb(255, 255, 255));
        centerLine.setColor(getResources().getColor(R.color.white20));
...
//                canvas.drawCircle(i * getMeasuredWidth() / maxPos(), getMeasuredHeight() - line_offset / 4, line_offset / 4, circlePaint);// 下圆
                canvas.drawLine(i * getMeasuredWidth() / maxPos(), 0, i * getMeasuredWidth() / maxPos(), getMeasuredHeight(), centerLine);//垂直的线
                //画正在播放的线
