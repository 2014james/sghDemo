...
public class EditWaveformView extends View {
    String TAG = EditWaveformView.class.getSimpleName();
    // Colors
    ...
    private int mPlaybackTop = -1;
    private int mPlaybackBottom = -1;
...
//                getResources().getColor(R.color.waveform_selected));
        ...
        mUnselectedLinePaint.setColor(getResources().getColor(R.color.white20));
    ...
    public void setTopback(int topback) {
        mPlaybackTop = topback;
    }

    public void setBottomback(int bottomback) {
        mPlaybackBottom = bottomback;
    }
...
//        }
        ...
        //画选择区域
        for (i = 0; i < maxPos(); i++) {
            if (i + start == mPlaybackTop) {
                mUnselectedLinePaint.setColor(getResources().getColor(R.color.white20));
                Log.e(TAG, "onDraw--> i:" + i + ";" + i * getMeasuredWidth() / maxPos() + ";maxpos:" + maxPos());
                Log.e(TAG, "onDraw--> h:" + getMeasuredHeight() + ";w:" + getWidth());
                canvas.drawRect(i * getMeasuredWidth() / maxPos(), 0, getMeasuredWidth(), getMeasuredHeight(), mUnselectedLinePaint);//垂直的线
            }
            if (i + start == mPlaybackBottom) {
                mUnselectedLinePaint.setColor(getResources().getColor(R.color.white20));
                canvas.drawRect(0, 0, i * getMeasuredWidth() / maxPos(), getMeasuredHeight(), mUnselectedLinePaint);//垂直的线
                isbottom = true;
            }
        }
        //滑动到结束 最后一帧
...
//                wavePaint = mSelectedLinePaint;
//            } else {
//                wavePaint = mUnselectedLinePaint;
//            }
//            wavePaint.setColor(MyApplication.getInstance().getColor(R.color.wave));
