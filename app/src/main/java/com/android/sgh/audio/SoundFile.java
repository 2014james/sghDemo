...
public class SoundFile implements Serializable {
    ...
    public int getSamplesPerFrame() {
        ...
        return  (mSampleRate * mChannels) / 50;
//        return 1024/2;  // just a fixed value here...
    ...
    private void ReadFile(File inputFile)
        ...
        Log.e(TAG, "==SoundFile=222= " + mFileSize);
        ...
        Log.e(TAG, "pixelsToMillisecsTotal 222- " + mSampleRate + " - " + mChannels);
        extractor.release();
        extractor = null;
        codec.stop();
        codec.release();
        ...
        Log.e(TAG, "pixelsToMillisecsTotal 222- " + mNumSamples+"sstest"+getSamplesPerFrame()+"--"+mNumFramesFloat);
